...
import 'package:firelamp/widgets/forum/shared/display_expand_files.dart';
...
class ImagePostView extends StatefulWidget {
  ...
  @override
  _ImagePostViewState createState() => _ImagePostViewState();
}
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        DisplayExpandFiles(postOrComment: widget.post),
